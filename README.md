...
One-line installers and release assets for the pinned **v4.37.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.
