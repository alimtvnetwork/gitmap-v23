...
// Release messages.
const (
	MsgReleaseStart         = "\n  " + ColorCyan + "▸ Creating release " + ColorWhite + "%s" + ColorReset + ColorCyan + "..." + ColorReset + "\n"
	MsgReleaseBranch        = "  " + ColorGreen + "✓ Created branch" + ColorReset + " %s\n"
	MsgReleaseTag           = "  " + ColorGreen + "✓ Created tag" + ColorReset + " %s\n"
	MsgReleasePushed        = "  " + ColorGreen + "✓ Pushed" + ColorReset + " branch and tag to " + ColorCyan + "origin" + ColorReset + "\n"
	MsgReleaseMeta          = "  " + ColorGreen + "✓ Release metadata written to" + ColorReset + " %s\n"
	MsgReleaseMetaCommitted = "  " + ColorGreen + "✓ Committed release metadata on" + ColorReset + " %s\n"
	MsgReleaseLatest        = "  " + ColorGreen + "✓ Marked" + ColorReset + " %s " + ColorGreen + "as latest release" + ColorReset + "\n"
	MsgReleaseAttach        = "  " + ColorGreen + "✓ Attached" + ColorReset + " %s\n"
	...
	MsgReleaseComplete      = "\n  " + ColorGreen + "── Release %s complete ──" + ColorReset + "\n"
...
const (
	GitmapRepoPrefix     = "github.com/alimtvnetwork/gitmap-v19"
